...
namespace Fractalscape
{
    public class Recticle : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            m_OriginalScale = new Vector3(.05f, .05f, 1f);
            m_OriginalRotation = m_ReticleTransform.localRotation;
            AppSession.Instance.Recticle = this;
            m_Camera = AppSession.AppCamera.transform;
        }
        ...
        public void SetPosition()
        {
            ...
            m_ReticleTransform.localRotation = Quaternion.LookRotation(m_Camera.forward);
        }
